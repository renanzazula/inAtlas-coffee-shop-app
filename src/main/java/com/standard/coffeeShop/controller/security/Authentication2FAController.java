...
@Api(value = "Manage User", tags = "authentication")
@Slf4j
@RestController
@RequestMapping(Authentication2FAController.USER_CONTROLLER_BASE_URL)
@RequiredArgsConstructor
public class Authentication2FAController {
    public static final String USER_CONTROLLER_BASE_URL = ConstantsApi.USER_2FA;
